...
#define SD_DEBUG_LOG 1  // SD 카드 디버그 로그 활성화
...
#define DISABLE_SD_INIT  // SD는 init_sdmmc()에서 이미 초기화됨
...
/* ENABLE_SCRATCH_BUFFER 비활성화: FATFS 구조체를 RAM_D2에 배치했으므로 직접 DMA 사용 가능 */
