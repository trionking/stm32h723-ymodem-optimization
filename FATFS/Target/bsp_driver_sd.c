...
#define SD_DEBUG_LOG 1  // SD 카드 디버그 로그 활성화 (sd_diskio.c와 동기화)
...
/* can be used to modify previous code / undefine following code / add code */
/* NOTE: BSP_SD_GetCardState is overridden with strong definition in user_def.c for debug logging */
...
/**
  ...
  * @retval None
  * @note Implementation moved to sd_diskio.c to avoid weak linking issues
  */
